...
<body class="font-sans antialiased bg-gray-50 text-black dark:bg-black dark:text-white/50">
    <div class="relative min-h-screen flex flex-col items-center justify-start">
        <!-- Cambiato justify-center a justify-start -->
                ...
                <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                    ...
                    <a href="#"
                        ...
                        <div
                            ...
                            <svg class="w-[27px] h-[27px] text-red-700 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <div
                        ...
                        <div
                            class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                            <svg class="w-[27px] h-[27px] text-red-700 dark:text-white" aria-hidden="true"
