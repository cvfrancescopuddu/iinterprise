    ...
    <div class="main-content mt-5">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="col-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex justify-content-end">
                                            <form method="GET" action="{{ route('client.search') }}" class="d-flex" role="search">
                                                        ...
                                                        @foreach ($clients as $client)
                                                            <tr>
                                                                ...
                                                                <td> <a class="btn btn-sm btn-info" href=""
                                                                        data-bs-toggle="modal" data-bs-target="#noteModal{{ $client->cid }}"
                                                                        data-id="{{ $client->cid }}"><i class="bi bi-info-circle"></i></a></td>
                                                                <td>
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <form action="{{ route('client.destroy', $client->cid) }}" method="POST">
                                                                            @csrf
                                                                            @method('GET')
