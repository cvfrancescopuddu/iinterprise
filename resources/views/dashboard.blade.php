                    ...
                    <div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                            <div class="grid grid-cols-3 gap-3 mb-2">
                                <dl
                                    ...
                                    <dt
                                        ...
                                        {{$urgentTasks}}</dt>
                                    <dd class="text-orange-600 dark:text-orange-300 text-sm font-medium">Urgenti</dd>
                                </dl>
                                <dl
                            ...
                            <button data-collapse-toggle="more-details" type="button"
                                ...
                                more details <svg class="w-2 h-2 ms-1" aria-hidden="true"
                            ...
                            <div id="more-details"
                                ...
                                <dl class="flex items-center justify-between">
                                    <dt class="text-gray-500 dark:text-gray-400 text-sm font-normal">Average task
                                        completion rate:</dt>
                                    <dd
                                ...
                                <dl class="flex items-center justify-between">
                                    <dt class="text-gray-500 dark:text-gray-400 text-sm font-normal">Days until sprint
                                        ends:</dt>
                                    <dd
